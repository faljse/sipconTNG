...
public abstract class Processor {
    ...
    public Processor(SipController sc) {
	this.sc = sc;
    }
    ...
    protected CallIdHeader createCallId(String address) {
	//String callId = "" + System.currentTimeMillis();

	String callId = "Utils.generateCallIdentifier(address);"; //TODO
	
	CallIdHeader callIdHeader = null;

	try {
	    callIdHeader =
		sc.headerFactory.createCallIdHeader(callId);
	}
