 ...
 */
public class TextControlPanel extends JPanel implements ActionListener {
    ...
    public TextControlPanel(ProgramWindow pw, String buttontext) {
	super();
	...
	clearButton = new JButton(buttontext);
	clearButton.addActionListener(this);
	clearButton.setMargin(new Insets(0, 10, 0, 10));
