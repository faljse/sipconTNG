 ...
 * <p> 
 * The SIP-If-Match header is used by a client (event state publisher) in a PUBLISH request,
 * to update previously published event state. The value is obtained from the server in a 
 * {@link javax.sip.header.SIPETagHeader} in a 2xx response to a previous PUBLISH. 
 * <p>
