 ...
 * <a href = "http://www.ietf.org/rfc/rfc3903.txt">RFC3903</a>, this 
 * header is not part of RFC3261.
 * <p> 
 * The SIP-ETag header is used by a server (event state collector) in a 2xx response to PUBLISH 
 * in order to convey a unique entity tag for the published state. The client may then use
 * this tag in a {@link javax.sip.header.SIPIfMatchHeader} to update previously published state
 * <p>
 ...
 * 
 * <p>Implementation Note - A for backwards compatibility, implementations of this interface
 * should implement ExtensionHeader.
 *
 * @since 1.2
